...
const galleryImages = [
  {
    src: "https://images.unsplash.com/photo-1464037866556-6812c9d1c72e?w=400&q=80&fit=crop",
    alt: "Airport control tower at dusk",
  },
  {
    src: "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=400&q=80&fit=crop&crop=faces",
    alt: "Female aviation professional",
  },
  {
    src: "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=400&q=80&fit=crop",
    alt: "Aircraft on runway at sunset",
  },
  {
    src: "https://images.unsplash.com/photo-1519167758481-83f550bb49b3?w=400&q=80&fit=crop",
    alt: "Awards gala event",
  },
];

export default function AAEAOurStory() {
  return (
    <section className="w-full bg-[#0b1a2e] font-sans">
      {/* ── Top row: text + gallery ── */}
      <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-16 pt-14 pb-10 flex flex-col lg:flex-row gap-10 lg:gap-14 items-start">
        {/* Left: text block */}
        <div className="flex-shrink-0 lg:w-[300px] xl:w-[340px]">
          {/* Label */}
          <p className="text-[#C9922A] text-[11px] font-bold tracking-[0.2em] uppercase mb-4">
            Our Story
          </p>

          {/* Headline */}
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-white leading-[1.1] mb-5">
            Honoring Today.
            <br />
            Inspiring Tomorrow.
          </h2>
        ...
        {/* Right: image gallery */}
        <div className="flex-1 grid grid-cols-4 gap-3 min-h-[220px]">
          {galleryImages.map((img, i) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#0b1a2e]/50 via-transparent to-transparent" />
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-16 py-8 flex flex-col sm:flex-row items-start sm:items-center gap-8 sm:gap-0">
        {/* Label */}
        <div className="sm:w-[220px] xl:w-[260px] flex-shrink-0 sm:border-r border-white/15 sm:pr-10">
