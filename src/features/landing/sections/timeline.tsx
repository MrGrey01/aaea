    ...
    <section className="py-24 bg-[#050814] border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6">
        <SectionHeading
          center
          title="The Process"
          subtitle="Key dates for the 2025 AAEA season."
        />
            ...
            {[
              {
                ...
                desc: "Portal opens for all categories.",
              },
              {
                date: "August 30, 2025",
                title: "Entry Deadline",
                desc: "Final day to submit documentation.",
              },
              {
                date: "October 15, 2025",
                title: "Shortlist Announced",
                desc: "Finalists revealed online.",
              },
              {
                date: "November 24, 2025",
                title: "Gala Ceremony",
                desc: "Live event at Abuja International Conference Center.",
              },
            ].map((item, idx) => (
              <div
                key={idx}
              ...
              >
                ...
                >
                  <span className="text-[#F5C76A] font-bold text-lg">
                    {item.date}
                  </span>
                </div>
              </div>
