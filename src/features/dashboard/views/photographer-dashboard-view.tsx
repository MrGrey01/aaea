      ...
      <section className="grid gap-4 xl:grid-cols-[1.2fr_0.8fr]">
        <Card className="border border-border/70 bg-card/80 py-0">
          <CardHeader className="border-b border-border/70 py-5">
            ...
            <CardDescription>
              The albums most likely to need your next upload, tweak, or share
              link.
            </CardDescription>
          </CardHeader>
        ...
        <div className="grid gap-4">
          <Card className="border border-border/70 bg-card/80 py-0">
            <CardHeader className="border-b border-border/70 py-5">
              ...
              <CardDescription>
                The places you will likely jump between while preparing a
                delivery.
              </CardDescription>
            </CardHeader>
          ...
          <Card className="border border-border/70 bg-card/80 py-0">
            ...
            <CardContent className="space-y-3 p-5 text-sm text-muted-foreground">
              <div className="flex items-start gap-3">
                ...
                <p>
                  Private galleries can be restricted by client email and access
                  code.
                </p>
              </div>
              <div className="flex items-start gap-3">
                ...
                <p>
                  Public galleries can capture leads before viewers browse your
                  images.
                </p>
              </div>
              <div className="flex items-start gap-3">
                ...
                <p>
                  Favorites and access activity give you a cleaner handoff after
                  every shoot.
                </p>
              </div>
            </CardContent>
      ...
      <section className="grid gap-4 md:grid-cols-3">
        ...
        <Card className="border border-border/70 bg-card/80 py-0">
          <CardContent className="space-y-2 p-5">
            ...
            <p className="text-sm text-muted-foreground">
              Your latest gallery activity is visible here so you can continue
              work without hunting for the right album.
            </p>
          </CardContent>
        </Card>
      </section>
